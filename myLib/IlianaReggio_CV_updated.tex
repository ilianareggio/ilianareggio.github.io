...
\vspace*{-1.5cm}
 \MyDate{Updated on October 2020}
%\sepspace
...
\PersonalEntry{Mail}{\url{ireggio@gmail.com}}
\vspace*{0.3cm}
...
\EducationEntry{Moral Hazard versus Liquidity and the Optimal Timing of Unemployment Benefits (with Rodolfo Campos and Ignacio García-Pérez), FEDEA Working Paper No. 2017/10}{}{}{}
%%% ------------------------------------------------------------
\vspace*{-0.5cm}
...
%\textbf{As instructor}
\EducationEntry{Macroeconomics: UAM}{2020-}{}{This is a second year Macro course. We cover topics like the determination of output, employment, interest rates, and inflation; and monetary and fiscal policies.}
